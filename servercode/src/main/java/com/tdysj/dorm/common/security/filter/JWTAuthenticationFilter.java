package com.tdysj.dorm.common.security.filter;
...
import com.tdysj.dorm.common.security.entity.LoginUser;
import com.tdysj.dorm.common.security.utils.JwtTokenUtils;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        response.getWriter().write(new JSONObject().toJSONString(com.tdysj.dorm.common.utils.R.ok(ResultEnums.SUCCESS)));
    }
